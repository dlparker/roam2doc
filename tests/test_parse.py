...
def test_buggy_list():
    ...
    lines.append('  + beebop :: arubop <<arubop>>')
    lines.append('  Some text as a paragraph in an item!!! (this is child of unordered secont)')
    ...
    lines.append('- unordered third')
    lines.append('  1. ordered first, child of unordered third')
    lines.append('     1. THIS GETS PLACED IN WRONG PARENT!!!!!!')
    lines.append('  2. ???')
